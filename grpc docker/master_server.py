# --- START OF FILE master_server.py (Modified for Docker with Clear Output) ---
...
class MasterServicer(pipeline_pb2_grpc.MasterServiceServicer):
    def RunPipeline(self, request, context):
        ...
        print("=" * 60)
        print("🚀 DOCKER gRPC MASTER ACTIVITY 🚀")
        print("=" * 60)
...
# --- END OF FILE master_server.py (Modified for Docker with Clear Output) ---