# --- START OF FILE client.py (for REST API) ---
import requests
import time
import json
...
def run_pipeline_client(data_size):
    ...
    print("=" * 60)
    print("🚀 STARTING REST API PIPELINE CLIENT 🚀")
    print("=" * 60)
    ...
    try:
        ...
        print(f"   Please ensure the Docker containers are running and port 5000 is exposed.")
        print(f"   Details: {e}")
        print("="*60)
